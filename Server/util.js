...
class FileService {
  constructor() {
    ...
    this.files = {
      ...
      pdeHeroScores: path.join(config.DATA, "pde_hero_scores.json"),
      ...
      chessGames: path.join(config.DATA, "chess_games.json"),
      chessWins: path.join(config.DATA, "chess_wins.json"),
      chessElo: path.join(config.DATA, "chess_elo.json"),
      ...
      blackjackShoe: path.join(config.DATA, "blackjack_shoe.json"),
  ...
  loadAll() {
    ...
    return {
      ...
      pdeHeroScores: this.readJSON(this.files.pdeHeroScores, {}),
      ...
      chessGames: this.readJSON(this.files.chessGames, {}),
      chessWins: this.readJSON(this.files.chessWins, {}),
      chessElo: this.readJSON(this.files.chessElo, {}),
      ...
      blackjackShoe: this.readJSON(this.files.blackjackShoe, []),
  ...
  save(key, data) {
    ...
    const fileMap = {
      ...
      pdeHeroScores: this.files.pdeHeroScores,
      runnerResume: this.files.runnerResume,
      unoWins: this.files.unoWins,
      unoStats: this.files.unoStats,
      p4Wins: this.files.p4Wins,
      chessGames: this.files.chessGames,
      chessWins: this.files.chessWins,
      chessElo: this.files.chessElo,
      ...
      blackjackShoe: this.files.blackjackShoe,
